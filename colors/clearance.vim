...
if version >= 700 " Vim 7.x specific colors
  hi CursorLine   guifg=#4f4f4f guibg=#1d1d1d gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=BOLD
  hi CursorLineNR guifg=#4f4f4f guibg=#1d1d1d gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=BOLD
